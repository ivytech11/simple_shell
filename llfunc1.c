...
/**
 * addnode_end - adds a new node at the end of a linked_l list;
...
/**
 * showlist - prints all elements of a linked_l list
...
/**
 * delnode_ndex - deletes the node at index
...
/**
 * list_lenght - returns the number of elements in a linked list
